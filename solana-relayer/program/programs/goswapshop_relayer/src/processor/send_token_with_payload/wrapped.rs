...
pub fn send_wrapped_tokens_with_payload(
    ...
    require!(valid_foreign_address(order_account.chain_id, &recipient_address), GoSwapShopError::InvalidRecipient);
    require!(recipient_chain == order_account.chain_id, GoSwapShopError::InvalidChain);
    let config_seeds = &[
