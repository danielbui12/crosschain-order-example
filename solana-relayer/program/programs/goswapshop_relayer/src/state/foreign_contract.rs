...
use crate::PostedGoSwapShopMessage;
...
impl ForeignContract {
    ...
    /// this account.
    pub fn verify(&self, vaa: &PostedGoSwapShopMessage) -> bool {
...
pub mod test {
    ...
    fn test_foreign_emitter() -> Result<()> {
        ...
        let vaa = PostedGoSwapShopMessage {
