...
import {GoSwapShopRelayerSetters, GoSwapShopRelayerStructs} from "./GoSwapShopRelayerSetters.sol";

contract GoSwapShopRelayerGetters is GoSwapShopRelayerSetters {
    ...
    function getOrderData(address user_, bytes32 orderId_) public view returns (GoSwapShopRelayerStructs.Order memory) {
