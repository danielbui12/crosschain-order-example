...
import {GoSwapShopRelayerGetters} from "./GoSwapShopRelayerGetters.sol";

contract GoSwapShopRelayerGovernance is GoSwapShopRelayerGetters {
    /**
     * @notice Registers foreign emitters (SwapShop contracts) with this contract
